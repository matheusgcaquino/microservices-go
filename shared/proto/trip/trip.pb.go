...
type Trip struct {
	...
	Driver        *TripDriver            `protobuf:"bytes,5,opt,name=driver,proto3" json:"driver,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_trip_proto_rawDesc = "" +
	...
	".trip.TripR\x04trip\"\xa4\x01\n" +
	"\x04Trip\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x122\n" +
	"\fselectedFare\x18\x02 \x01(\v2\x0e.trip.RideFareR\fselectedFare\x12\x16\n" +
	"\x06status\x18\x03 \x01(\tR\x06status\x12\x16\n" +
	"\x06userID\x18\x04 \x01(\tR\x06userID\x12(\n" +
	"\x06driver\x18\x05 \x01(\v2\x10.trip.TripDriverR\x06driver\"t\n" +
	"\n" +
	"TripDriver\x12\x0e\n" +
